...
const projects: ProjectEntry[] = [
  ...
  },
  {
    ...
    modalContent: {
      ...
      description: [
        "Every solution begins with a friction point. In my neighborhood, it was the courts, tennis, basketball, badminton, each with their own paper logbooks and silent frustrations. Double bookings, no-shows, and miscommunication were common, not out of negligence but because the system simply wasn’t built to scale with the people using it. I saw an opportunity: not just to digitize a process, but to reimagine what coordination could feel like when technology works as it should, seamlessly, quietly, and purposefully.",
        ...
        "The UI was designed with clarity in mind: calendar-based booking views, time slot selectors, real-time updates, and user information handling. State management was handled through useState and useEffect hooks for lightweight responsiveness. Axios handled live asynchronous communication with the backend REST API.",
...
const skills = {
  ...
  "AI & Tooling": {"LangChain + OpenAI": "/langchain.svg", "YOLO": "/yolo.svg", "TensorFlow": "/tensorflow.svg", "PyTorch": "/pytorch.svg", "Pandas": "/pandas.svg", "Vercel": "/vercel.svg", "Figma": "/figma.svg"},
};
